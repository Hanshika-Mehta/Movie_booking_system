...
const Bookings = () => {
  ...
  const handlePost = async () => {
    try {
      ...
      const year = prompt("Enter release date:");
  ...
  return (
    <>
      ...
      <div className="bg-gray-900 text-white p-4">
        <h1 className="text-4xl mb-6">Bookings Details</h1>
                       ...
                       href={{ 
                        ...
                        query:{
                          movie_name:movie.movie_name,  
                            ...
                            <span className="text-white hover:bg-blue-500 py-2 px-4 rounded cursor-pointer">Book Tickets</span>
                       </Link>
                    </button> */}
